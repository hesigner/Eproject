...
?>
    ...
    <div class="box3 row m-0" style="margin-bottom: 10px !important;">
        <div class="col-lg-12">
            ...
            <h1 class="pt-3">Show Off Your Skills In <?= $data['comp_name'] ?> Compititon ?</h1>
            <h2 class="compitem">Play this competition to test your Writing skills. Topic in this compititon will be on
        ...
        <h1 class="compstart">Compititon start date : <?= $data['start_date'] ?></h1>
...
<div class="AddcategoryModal" id="AddcategoryModal" style="display:none;">
    ...
    <div class="row">
        <h1 class="col-12" style="font-size: 18px;">
            Just to test your skills please, Write small paragraph on any animal.
        </h1>
        <textarea name="" id="" cols="30" rows="10" class="col-12 "></textarea>
        <input type="submit" name="" id="" value="Submit" class="bg-dark"
