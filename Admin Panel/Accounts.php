    ...
    <div class="AddcategoryModal" id="AddcategoryModal" style="display:none;">
        ...
        <form action="Operations/Account_Crud.php" method="post">
            <div class="Addaccount form-group row">
                ...
                <input type="date" id="currentdate" name="DOR" class="form-control logininput col-9 mb-2">
                ...
                <input type="number" name="Age" class="form-control logininput col-3 mb-2">

                <label class="col-3">Name</label>
                <input type="text" name="Name" class="form-control logininput col-9 mb-2">

                <label class="col-3">Address</label>
                <input type="text" name="Address" class="form-control logininput col-9 mb-2">

                <label class="col-3">Qualification</label>
                <input type="text" name="Qualification" class="form-control logininput col-9 mb-2">

                <label class="col-3">Contact</label>
                <input type="number" name="Contact" class="form-control logininput col-9 mb-2">

                <label class="col-3">Email</label>
                <input type="text" name="Email" class="form-control logininput col-9 mb-2">

                <label class="col-3">Password</label>
                <input type="password" name="Password" class="form-control logininput col-9 mb-2">
