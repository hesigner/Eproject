...
<body>
    ...
    <div class="container mt-3 bg-white col-md-9" style="border: none; box-shadow: 0px 0px 5px 5px rgba(0,0,0,0.5);">           
            ...
            <div class="row">
                ...
                <div class="col-md-12">                    
                    <div class="form-group mt-2">
                    <p style="font-weight:bold; margin-bottom:2px;">Customer Email:  <span style="border-bottom:2px solid black; margin-bottom:2px;"><?php echo @$_SESSION['CustEmail']; ?></span></p>
                ...
                <div class="col-md-12">                    
                    <div class="form-group mt-2">
                    <p style="font-weight:bold; border-bottom:2px dashed red;">Customer Contact:    <span style="border-bottom:1px solid black; margin-bottom:2px;"> <?php echo @$_SESSION['CustContact']; ?></span></p>
