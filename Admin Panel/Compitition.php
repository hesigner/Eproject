...
<div class="pageMaterial" id="pageMaterial">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    echo '<tr>'; ?>  
                      ...
                      <td><a href="Operations/Compitition_Crud.php?Delid=<?= $data['compid'] ?>">
        ...
        <form action="Operations/Compitition_Crud.php" method="post">
            <div class="Addaccount form-group row">
                <h1 class="col-12" style="padding-bottom: 5px; COLOR:#5271ff;">
                    ADD <span style="color:rgba(31, 31, 31, 0.719);">COMPETITION<span>
                </h1>
                <label class="col-3">Competition Name</label>
                <input type="text" name="compname" class="form-control logininput col-9 mb-2">

                <label class="col-3">Topic</label>
                <input type="text" name="topic" class="form-control logininput col-9 mb-2">


                <label class="col-3">Start Date</label>
                <input type="date"  name="startdate" class="form-control logininput col-9 mb-2">


                <label class="col-3">Passing Marks</label>
                <input type="text"  name="passingmarks" class="form-control logininput col-9 mb-2">


                <label class="col-3">Total Marks</label>
                <input type="text"  name="totalmarks" class="form-control logininput col-9 mb-2">

                <button type="submit" name="AddCompetititon" class="btn btn-primary form-control mt-2"
    ...
    Competition already <b>Exists</b> !
</div>
    ...
    Competition has been <b>Updated</b> Sucessfully!
</div>
...
Competition has been <b>Deleted</b> Sucessfully!
</div>
...
Competition has been <b>Added</b> Sucessfully!
</div>
<?php
@
  $ID = $_GET['added'];
