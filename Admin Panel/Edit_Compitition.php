    ...
    <div class="AddcategoryModal" id="AddcategoryModal" style="display: ;">
        ...
        <form action="Operations/Compitition_Crud.php" method="post">
            <div class="Addaccount form-group row">
                ...
                <input type="text" style="background-color:darkgrey !important; color: white;" value="<?= $catdata['compid']?>" name="competitionid" class="form-control logininput col-9 mb-2">

                <label class="col-3">Competition Name</label>
                <input type="text" value="<?= $catdata['comp_name']?>" name="compname" class="form-control logininput col-9 mb-2">

                <label class="col-3">Topic</label>
                <input type="text" value="<?= $catdata['Topics']?>" name="topic" class="form-control logininput col-9 mb-2">


                <label class="col-3">Start Date</label>
                <input type="date" value="<?= $catdata['start_date']?>" name="startdate" class="form-control logininput col-9 mb-2">


                <label class="col-3">Passing Marks</label>
                <input type="text" value="<?= $catdata['Passing_Marks']?>" name="passingmarks" class="form-control logininput col-9 mb-2">


                <label class="col-3">Total Marks</label>
                <input type="text" value="<?= $catdata['Total_Marks']?>" name="totalmarks" class="form-control logininput col-9 mb-2">
