    ...
    <div class="AddcategoryModal" id="AddcategoryModal" style="display:none ;">
        ...
        <form action="Operations/Dealer_Crud.php" method = "post">
            <div class="Addaccount form-group row">
              ...
              <input type="text" name="Dealer_Name" class="form-control logininput col-9 mb-2">
              
              <label class="col-3">Shop Name</label>
              <input type="text" name="Shop_Name" class="form-control logininput col-9 mb-2">

              <label class="col-3">Shop Location</label>
              <input type="text" name="Dealer_Location" class="form-control logininput col-9 mb-2">
              
              <label class="col-3">City</label>
              <input type="text" name="City" class="form-control logininput col-9 mb-2">

              <label class="col-3">Contact</label>
              <input type="text" name="Contact" class="form-control logininput col-9 mb-2">
