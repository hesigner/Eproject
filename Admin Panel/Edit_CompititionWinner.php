        ...
        <form action="Operations/CompititionWinner_Crud.php" method="post">
            <div class="Addaccount form-group row">
                <h1 class="col-12" style="padding-bottom: 5px; COLOR:#5271ff;">
                    EDIT <span style="color:rgba(31, 31, 31, 0.719);">WINNER<span>
                </h1>
                <label class="col-3">Winner Id</label>
                <input type="text" value = "<?= $catdata['winid']?>"  name="winnerid" class="form-control logininput col-9 mb-2">

                <label class="col-3">Competition</label>
                <select name="winnercompititon" class="form-control logininput col-9 mb-2">
                  <option selected value = "<?= $catdata['compid']?>"><?= $catdata['comp_name']?></option>
                  <?php 
                ...
                <input type="number" value = "<?= $catdata['prizes']?>"  name="winnerprice" class="form-control logininput col-9 mb-2">

                <label class="col-3">Winner</label>

                <select name="winnerCustomer" class="form-control logininput col-9 mb-2">
                <option selected value = "<?= $catdata['custid']?>"><?= $catdata['Name']?></option>
                  <?php 
                ...
                <button type="submit" name="UpdateWinner" class="btn btn-primary form-control mt-2"
