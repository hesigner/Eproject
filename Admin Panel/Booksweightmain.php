...
<div class="Box">
            <div class="addbutton">
                <h1 onclick="openAddModal()">ADD WEIGHT</h1>
            </div>
            <div class="categoryTable">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                    $querys = 'select * from book_weight
                    INNER JOIN books on books.Bookid = book_weight.bookid
                    INNER JOIN booktype on booktype.Typeid = book_weight.Booktype
                    ';
                    $res = mysqli_query($con, $querys);
                    while ($data = mysqli_fetch_assoc($res)) {
                    echo '<tr>'; ?>  
                      <th scope="row"><?= $data['weightid'] ?></th>
                      <td><?= $data['Book_Name'] ?></td>
                      <td><?= $data['weight'] ?></td>
                      <td><?= $data['Type'] ?></td>

                      <td><a href="Operations/Bookweight_Crud.php?Delid=<?= $data['weightid'] ?>">
    ...
    <div class="AddcategoryModal" id="AddcategoryModal" style="display: none;">
        ...
        <form action="Operations/Bookweight_Crud.php" method = "post">
            <div class="form-group">
              <label>Wight</label>
              <input type="text" name="weight" class="form-control logininput">

              <label>For Book</label>
              <select class="form-control logininput " id="BookName" name = "bookname">
              ...
              <select class="form-control logininput " id="BookName" name = "booktype">
              ...
              <button type="submit" name="addweight" class="btn btn-primary form-control mt-2" style="background-color:#5271ff;">Add</button>
            </div>
        </form>
    </div>
    ...
    Book Weight already <b>Exists</b> !
</div>
    ...
    Book Weight has been <b>Updated</b> Sucessfully!
</div>
...
Book Weight has been <b>Deleted</b> Sucessfully!
</div>
...
Book Weight has been <b>Added</b> Sucessfully!
</div>
<?php
@
  $ID = $_GET['added'];
